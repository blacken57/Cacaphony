...
public class MenusOc extends AppCompatActivity {
    private static final String TAG = "HELLOOOO";
    RecyclerView recyclerView;
    MenuAdapterOc adapter;
    List<MenuObjectOc> MenuList;
    FirebaseAuth mFAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menus_oc);
        fStore = FirebaseFirestore.getInstance();
        mFAuth = FirebaseAuth.getInstance();
        MenuList = new ArrayList<MenuObjectOc>();
        recyclerView = findViewById(R.id.recyclerViewOc);
        recyclerView.setHasFixedSize(true);
        bt = findViewById(R.id.orderOc);
                        ...
                        fStore.collection("Restaurants").document(RestroID).collection("Food Items").get()
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(MenusOc.this, "failed :(", Toast.LENGTH_SHORT).show();
